...
public class Employee {
	...
	@ManyToOne(fetch = FetchType.LAZY)
	@JoinColumn(name = "pre_chaitanya_id", nullable = true)
	private Employee pre_chaitanya_id; // Optional - previous Chaitanya employee ID (must be inactive employee with is_active = 0)
