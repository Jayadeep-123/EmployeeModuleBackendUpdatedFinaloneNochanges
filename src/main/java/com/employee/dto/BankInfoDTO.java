...
public class BankInfoDTO {
	...
	private Integer bankBranchId; // From "Bank Branch" dropdown - maps to OrgBankBranch.org_bank_branch_id (ONLY for Salary Account) - Optional: can provide ID or name
	private String bankBranchName; // Bank Branch Name - can be provided instead of bankBranchId (ONLY for Salary Account)
